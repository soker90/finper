...
/* v8 ignore next — requestMonth === 0 (January) edge case not covered by current tests */
...
export const calcBudgetByMonths = ({
  ...
  /* v8 ignore next — false branch (month specific request) not exercised in current budget tests */
