...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: 'contexts', replacement: path.resolve(import.meta.dirname, 'src/contexts') },
      { find: 'guards', replacement: path.resolve(import.meta.dirname, 'src/guards') },
      ...
      { find: 'types', replacement: path.resolve(import.meta.dirname, 'src/types') },
      { find: 'themes', replacement: path.resolve(import.meta.dirname, 'src/themes') },
