    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        variants: [
          ...
          { props: { variant: 'contained', color: 'secondary' }, style: getColorStyle({ variant: 'contained', color: 'secondary', theme }) },
          ...
          { props: { variant: 'outlined', color: 'secondary' }, style: getColorStyle({ variant: 'outlined', color: 'secondary', theme }) },
