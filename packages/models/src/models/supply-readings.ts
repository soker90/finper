...
const supplyReadingSchema = new Schema<ISupplyReading>({
  ...
  endDate: { type: Number, required: true, validate: { validator: function (this: any, value: number) { return value > this.startDate }, message: 'La fecha de fin debe ser posterior a la fecha de inicio' } },
